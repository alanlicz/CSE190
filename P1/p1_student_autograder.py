...
Project 1 in CSE 190, Early Fall Start, 2019.
...
So passing all the test here, although very
...
print("EXERCISE 2:")
test1(2, student.three_x_squared_plus_2_x_plus_1, 5, 86, 2)
...
print("EXERCISE 5:")
# EXERCISE 5:
test1(5, student.cube_root, 8, 2, 2)

print("EXERCISE 6:")
# EXERCISE 6:
test1(6, student.makepal, [1, 5], [1, 5, 5, 1], 2)
